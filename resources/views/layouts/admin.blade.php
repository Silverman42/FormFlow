...
<head>
    ...
    <title> @yield('titlt', 'Default Title') </title>

    <!-- vendor css -->
    <link href="{{ asset('custom/lib/@fortawesome/fontawesome-free/custom/css/all.min.css') }}" rel="stylesheet">
    <link href="{{ asset('custom/lib/ionicons/custom/css/ionicons.min.css') }}" rel="stylesheet">
    ...
    <div id="admin">
        <header class="navbar navbar-header navbar-header-fixed">
            ...
            <div class="navbar-brand">
                <a href="../../index.html" class="df-logo">Form<span>flow</span></a>
            </div><!-- navbar-brand -->
            <div id="navbarMenu" class="navbar-menu-wrapper">
                ...
                <ul class="nav navbar-menu">
                    ...
                    <router-link tag="li" :to='{path: "/home"}' active-class="active" class="nav-item"><a
                            class="nav-link"><i data-feather="box"></i>
                            Dashboard</a></router-link>
                    <router-link tag="li" :to='{path: "/forms"}' active-class="active" class="nav-item"><a
                            class="nav-link"><i data-feather="archive"></i>
                            Forms</a></router-link>
                    <router-link tag="li" :to='{path: "/integrations"}' active-class="active" class="nav-item"><a
                            href="#" class="nav-link"><i data-feather="refresh-ccw"></i>
                            Integrations</a></router-link>
                    <router-link tag="li" :to='{path: "/balance"}' active-class="active" class="nav-item"><a href="#"
                            class="nav-link"><i data-feather="dollar-sign"></i>
                ...
                <div class="dropdown dropdown-profile custom-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right tx-13">
                        ...
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                            <button class="btn btn-block btn-primary mg-t-15" type="submit"><i
        ...
        <footer class="footer">
            <div>
                ...
                <span>Created by <a href="http://silverman42.github.io">Nkeze Sylvester</a></span>
            </div>
            <div>
                <nav class="nav">
